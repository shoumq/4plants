                        ...
                        <form method="POST" action="{{ route('register') }}">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="surname" type="surname"
                                           ...
                                           value="{{ old('email') }}" required autocomplete="surname">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="phone" type="phone"
                                           class="form-control @error('phone') is-invalid @enderror" name="password"
                            ...
                            <div class="row mb-3">
                                <label for="password-confirm"
                                       class="col-md-4 col-form-label text-md-end">{{ __('Повторить пароль') }}</label>
                            ...
                            <input style="display: none" value="0" id="admin" name="admin" type="text"/>
